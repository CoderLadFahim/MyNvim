...
maps.n["<leader>q"] = { ":q!", desc = "Quit" }
maps.n["<leader>v"] = { "<C-v>", desc = "Vertical Selection" }
maps.n["<leader>src"] = { ":source %", desc = "Source" }
maps.n["<leader>tn"] = { ":tabedit<cr>", desc = "Open a new tab" }
maps.n["<leader>tq"] = { ":tabclose!<cr>", desc = "Close current tab" }
maps.n["<leader>taq"] = { ":tabonly!<cr>", desc = "Close all tabs but the current one" }
maps.n["<leader>fr"] = { ":%s/", desc = "Find and replace words" }
...
-- Packer
maps.n["<leader>pc"] = { "<cmd>PackerClean<cr>", desc = "Packer Clean" }
...
if is_available "gitsigns.nvim" then
  maps.n["<leader>]]"] = { function() require("gitsigns").next_hunk() end, desc = "Next git hunk" }
  maps.n["<leader>[["] = { function() require("gitsigns").prev_hunk() end, desc = "Previous git hunk" }
  maps.n["<leader>hb"] = { function() require("gitsigns").blame_line() end, desc = "View git blame" }
  maps.n["<leader>hv"] = { function() require("gitsigns").preview_hunk() end, desc = "Preview git hunk" }
  maps.n["<leader>hr"] = { function() require("gitsigns").reset_hunk() end, desc = "Reset git hunk" }
  -- maps.n["<leader>hr"] = { function() require("gitsigns").reset_buffer() end, desc = "Reset git buffer" }
  maps.n["<leader>hs"] = { function() require("gitsigns").stage_hunk() end, desc = "Stage git hunk" }
  maps.n["<leader>hu"] = { function() require("gitsigns").undo_stage_hunk() end, desc = "Unstage git hunk" }
  maps.n["<leader>hd"] = { function() require("gitsigns").diffthis() end, desc = "View git diff" }
end

-- NeoTree
if is_available "neo-tree.nvim" then
  maps.n["<leader>ft"] = { "<cmd>Neotree toggle<cr>", desc = "Toggle Explorer" }
...
if is_available "mason-lspconfig.nvim" then
  ...
  maps.n["<C-]>"] = { "<cmd>:lua vim.lsp.buf.definition()<cr>", desc = "Go to definition" } 
end

-- Smart Splits
if is_available "smart-splits.nvim" then
  -- Better window navigation
  maps.n["<leader>hh"] = { function() require("smart-splits").move_cursor_left() end, desc = "Move to left split" }
  maps.n["<leader>jj"] = { function() require("smart-splits").move_cursor_down() end, desc = "Move to below split" }
  maps.n["<leader>kk"] = { function() require("smart-splits").move_cursor_up() end, desc = "Move to above split" }
...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>gs"] = { function() require("telescope.builtin").git_status() end, desc = "Git status" }
  ...
  maps.n["<leader>ks"] = { function() require("telescope.builtin").keymaps() end, desc = "Search keymaps" }
  maps.n["<leader>cs"] = { function() require("telescope.builtin").commands() end, desc = "Search commands" }
  -- maps.n["<leader>sl"] = {
  --   function()
